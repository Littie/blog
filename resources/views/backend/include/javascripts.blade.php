...
<script src="{{ asset('js/price-regulator/jshashtable-2.1_src.js') }}"></script>
<script src="{{ asset('js/price-regulator/jquery.numberformatter-1.2.3.js') }}"></script>
<script src="{{ asset('js/price-regulator/tmpl.js') }}"></script>
<script src="{{ asset('js/price-regulator/jquery.dependClass-0.1.js') }}"></script>
<script src="{{ asset('js/price-regulator/draggable-0.1.js') }}"></script>
<script src="{{ asset('js/price-regulator/jquery.slider.js') }}"></script>
...
<script src="{{ asset('js/jquery.easypiechart.min.j') }}s"></script>
...
<script src="{{ asset('js/pixastic.custom.js') }}"></script>
<script src="{{ asset('js/livicons-1.4.min.js') }}"></script>
<script src="{{ asset('js/layerslider/greensock.js') }}"></script>
<script src="{{ asset('js/layerslider/layerslider.transitions.js') }}"></script>
<script src="{{ asset('js/layerslider/layerslider.kreaturamedia.jquery.js') }}"></script>
